...
// 💡 Lucide icons are React components, but you need to import them directly to use their type (LucideIcon)
...
interface WorkflowStep {
    ...
    title: string;
    description: string;
    // 💡 LucideIcon type for the icon component
    icon: LucideIcon; 
}
...
const HowWeWorkSection: React.FC = () => {
    ...
    // 💡 Framer Motion's useScroll hook is generic enough, but we rely on its inferred types
    ...
    // 💡 Apply the WorkflowStep interface
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="hidden lg:block relative">
                    ...
                    <div className="absolute top-24 left-0 right-0 h-1 bg-gray-200">
                        {/* 💡 useTransform is used to map scrollYProgress (0 to 1) to the desired range */}
                        <motion.div
                            style={{
                    ...
                    <div className="grid grid-cols-5 gap-4">
                        {workflowSteps.map((step, index) => (
                            ...
                            >
                                ...
                                >
                                    {/* 💡 Renamed component variable to start with capital letter for JSX usage */}
                ...
                <div className="lg:hidden relative">
                    ...
                    <div className="absolute left-8 top-0 bottom-0 w-1 bg-gray-200">
                        {/* 💡 useTransform for vertical scroll progress */}
                        <motion.div
                            style={{
