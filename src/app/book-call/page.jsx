"use client"; // MANDATORY: Required due to use of useState, useMemo, and framer-motion

import React, { useState, useMemo } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { Check, ArrowRight, X, Loader2, Calendar } from "lucide-react";
import Head from "next/head";
// --- Configuration Data (Next.js Update) ---

// 1. Next.js uses standard process.env.NEXT_PUBLIC_... for client-side env variables.
// However, since you have an internal API route:
// We will call the relative path directly, making the full URL unnecessary here.
const API_ENDPOINT = "/api/submit-inquiry";
...
// Converted to TypeScript where types are simple/implicit (like props from parent)
...
const BookACallForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Use the relative API_ENDPOINT (Next.js API Route)
      ...
      setSubmissionError(
        `Submission failed. Please check the console or try again. (${error.message})`
      );
    } finally {
  ...
  return (
    <>
      <Head>
        <title>
          Book a Call – BeezTech Branding & Web/App Development Agency in
          Udaipur
        </title>

        <meta
          name="description"
          content="Schedule a free consultation with BeezTech, the leading Branding and Web/App Development agency in Udaipur. Discuss your project, branding, or digital solutions with our experts."
        />

        <meta
          name="keywords"
          content="Book a Call Udaipur, BeezTech consultation, Branding agency Udaipur, Web development Udaipur, App development Udaipur, UI/UX design Udaipur"
        />
        ...
        <meta
          property="og:title"
          content="Book a Call – BeezTech Branding & Web/App Development Agency in Udaipur"
        />
        <meta
          property="og:description"
          content="Schedule a consultation with BeezTech, Udaipur's top Branding & Web/App Development agency. Talk to our experts about your project today."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://www.beeztech.studio/book-call"
        />
        {/* <meta property="og:image" content="https://www.beeztech.studio/images/og-book-call.png" /> */}
        ...
        <meta
          ...
          content="Schedule a consultation with BeezTech, Udaipur's top Branding & Web/App Development agency. Talk to our experts about your project today."
        />
        {/* <meta name="twitter:image" content="https://www.beeztech.studio/images/og-book-call.png" /> */}

        {/* Canonical */}
        <link rel="canonical" href="https://www.beeztech.studio/book-call" />
      </Head>
...
const Step1 = ({ formData, updateFormData, errors }) => (
  <div className="space-y-6">
    ...
    <p className="text-sm text-gray-500">
      Don’t worry, this takes less than a minute.
    </p>
...
const Step3 = ({
  ...
  const summaryData = useMemo(() => {
    return [
      {
        label: "Project Needs",
        value: formData.services.join(", ") || "Not specified",
      },
      {
        label: "Project Stage",
        value: formData.project_stage || "Not specified",
      },
        ...
        <div className="space-y-2">
          {summaryData.map((item) => (
            <div key={item.label} className="flex justify-between text-sm">
              ...
              <span className="font-semibold text-gray-900 max-w-[60%] truncate">
                {item.value}
              </span>
            </div>
          ))}
...
const SuccessMessage = () => (
  <div className="flex justify-center items-center min-h-screen bg-transparent p-4 sm:p-8 font-Epilogue">
    <motion.div
    ...
    >
      ...
      <p className="text-lg text-gray-700">
        Thank you! Our creative team will reach out shortly to schedule your
        call and discuss your project needs.
      </p>
