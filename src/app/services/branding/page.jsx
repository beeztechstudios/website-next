...
const BrandingPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Branding Services in Udaipur – BeezTech</title>

        <meta
          name="description"
          content="BeezTech offers professional Branding services in Udaipur. Our expertise includes logo design, brand identity & visual system, packaging graphics, print design, brand guidelines, and UI/UX design for web and mobile applications."
        />

        <meta
          name="keywords"
          content="Branding Udaipur, Logo design Udaipur, Brand identity Udaipur, Packaging design Udaipur, Print design Udaipur, Brand guidelines Udaipur, UI/UX design Udaipur, BeezTech Branding Services"
        />
        ...
        <meta
          property="og:title"
          content="Branding Services in Udaipur – BeezTech"
        />
        <meta
          property="og:description"
          content="Professional Branding services by BeezTech in Udaipur. We specialize in logo design, brand identity, packaging graphics, print design, brand guidelines, and UI/UX design for web & mobile apps."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://www.beeztech.studio/services/branding"
        />
        <meta
          property="og:image"
          content="https://www.beeztech.studio/images/og-branding.png"
        />
        ...
        <link
          rel="canonical"
          href="https://www.beeztech.studio/services/branding"
        />
      </Head>
